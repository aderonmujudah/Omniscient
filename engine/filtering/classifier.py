...
class SampleClassifier:
    ...
    def __init__(
        ...
        self._ear_threshold = 0.18 if ear_threshold is None else ear_threshold
    ...
    def classify(
        ...
        Args:
            ...
            blink_score: Averaged bilateral closure score.
        ...
        if blink_score is not None:
            if blink_score > max(0.5, 1.0 - self._ear_threshold):
